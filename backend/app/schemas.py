...
class Exchange(StrEnum): BINANCE="binance"; BITGET="bitget"; HYPERLIQUID="hyperliquid"; LIGHTER="lighter"; BITCOIN="bitcoin"; ETHEREUM="ethereum"; ARBITRUM="arbitrum"; SOLANA="solana"
...
class AccountRename(BaseModel): name: str=Field(min_length=1,max_length=128)
